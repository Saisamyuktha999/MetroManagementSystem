...
public interface MetroDaoInterface {
    ...
    public boolean updateTransactionHistory(int transid,int cardId,int sourceid,int destinationId,int fare)throws SQLException, IOException, ClassNotFoundException ;
